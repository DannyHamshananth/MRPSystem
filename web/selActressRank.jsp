<%-- 
    Document   : selActressRank
    Created on : Sep 15, 2017, 12:50:59 PM
    Author     : ASUS-PC
--%>
        ...
        <div class="container">
            <table class="table">
                ...
                <%
                    ...
                    String query = "SELECT actor_id,actor_name,actor_rank FROM `actor` WHERE actor_gender=1 ORDER BY `actor`.`actor_rank`";
                    Statement stmt = null;
                    ResultSet rs = null;
